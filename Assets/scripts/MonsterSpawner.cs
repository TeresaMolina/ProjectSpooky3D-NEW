...
public class MonsterSpawner : MonoBehaviour
{
    ...
    public int maxMonsters = 3;            // cap on how many exist at once
    ...
    void SpawnMonster()
    {
        ...
        // Raycast to floor
        if (Physics.Raycast(randPos + Vector3.up * 50, Vector3.down, out var hit, 100f, groundLayer))
        {
        ...
        if (agent != null && !agent.isOnNavMesh && NavMesh.SamplePosition(randPos, out var navHit, 50f, NavMesh.AllAreas))
        {
